...
class PapersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create paper" do
    assert_difference('Paper.count') do
      post papers_url, params: { paper: { accepted: @paper.accepted, author: @paper.author, doc_url: @paper.doc_url, track: @paper.track } }
    end
  ...
  test "should update paper" do
    patch paper_url(@paper), params: { paper: { accepted: @paper.accepted, author: @paper.author, doc_url: @paper.doc_url, track: @paper.track } }
